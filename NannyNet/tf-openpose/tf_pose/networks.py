...
def get_graph_path(model_name):
    dyn_graph_path = {
        'cmu': os.path.join('graph', 'cmu', 'graph_opt.pb'),
        'openpose_quantize': os.path.join('graph', 'cmu', 'graph_opt_q.pb'),
        'mobilenet_thin': os.path.join('graph', 'mobilenet_thin', 'graph_opt.pb'),
        'mobilenet_v2_large': os.path.join('graph', 'mobilenet_v2_large', 'graph_opt.pb'),
        'mobilenet_v2_large_r0.5': os.path.join('graph', 'mobilenet_v2_large','graph_r0.5_opt.pb'),
        'mobilenet_v2_large_quantize': os.path.join('graph', 'mobilenet_v2_large','graph_opt_q.pb'),
        'mobilenet_v2_small': os.path.join('graph', 'mobilenet_v2_small','graph_opt.pb'),
    }
